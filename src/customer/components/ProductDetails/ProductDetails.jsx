  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              {product.images.map((item) => (
                <div className="aspect-h-2 apsect-w-3 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] mt-4">
                  <img
                    alt={item.alt}
                    src={item.src}
                    className="h-full w-full object-cover object-center"
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">5646 Ratings</p>
        ...
        {/* {/*SECTION 2  -> RATING AND REVIEW </>/} */}

        <section>
          <h1 className="font-semibold text-lg pb-2 text-left">
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60">59333 Ratings</p>
                </div>
        ...
        <section className="pt-10">
              <h1 className="py-5 text-xl font-bold text-left" >
                Similar Products
              </h1>
