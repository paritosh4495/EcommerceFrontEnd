...
export default function Product() {
  ...
  console.log("PRODUCT INSIDE PRODUCT  : ",products);
  ...
  useEffect(() => { 
    ...
    const data = {
      ...
      colors: colorValue && colorValue.length > 0 ? colorValue : null, // Pass null if empty
      sizes: sizeValue && sizeValue.length > 0 ? sizeValue : null, // Pass null if empty
      minPrice,
      maxPrice,
      ...
      pageSize: 10,
      stock: stock || null, // Pass null if no stock filter is applied
    };
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              <div>
                <div className=" py-10 flex justify-between items-center">
                  <h1 className="text-lg font-bold  opacity-50 text-left">
                    Filters
                  </h1>
                  <FilterListIcon />
                </div>
